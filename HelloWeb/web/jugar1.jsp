        ...
        <section style="background-color: lightblue;" id="services" class="section">
            <div class="container" >
                    ...
                    <div class="col-sm-10 text-center-mobile">
                        ...
                        <div  >
                            <table class="table table-bordered text-center col-lg-offset-2" style="border-color:blue;border:6px !important">
                                <tr>
                             ...
                             <form name="idCliente Input Form" action="jugarC.jsp">
                                <div class="col-md-2 col-lg-offset-3 text-center-mobile">
                                    <input type="submit" class="btn btn-block btn-blue"  value="Jugar Cruz" />
                                </div>
                            </form>
                            <form name="idCliente Input Form" action="jugarE.jsp">
                                <div class="col-md-2 col-lg-offset-4 text-center-mobile">
                                    <input type="submit" class="btn btn-block btn-blue"  value="Jugar Esquinas" />
                                </div>
                            </form>
                            <form name="idCliente Input Form" action="jugarL.jsp">
                                <div class="col-md-2 col-lg-offset-6 text-center-mobile">
                                    <input type="submit" class="btn btn-block btn-blue"  value="Jugar Lleno" />
                                </div>
                            </form>
